    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Individual company shares and stock market investments", "Stocks" },
                    { 2, "Fixed income securities", "Bonds" },
                    { 3, "Property investments", "Real Estate" },
                    { 4, "Professionally managed investment funds", "Mutual Funds" },
                    { 5, "Exchange-traded funds", "ETF" },
                    { 6, "Retirement-specific investment accounts", "Retirement" },
                    { 7, "Digital currency investments", "Cryptocurrency" },
                    { 8, "Other types of investments", "Other" }
                });
